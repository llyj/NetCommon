...
namespace EasyBom.DataCenter.Model
{
    ...
    public class Info_MfgDetails
    {
        ...
        public List<Info_BrandRelated> Info_BrandRelateds { get; set; }

        /// <summary>
        /// 厂商重定向
        /// </summary>
        [JsonPropertyName("RedirectMfgModel")]
        public RedirectMfgModel RedirectMfgModel { get; set; }
